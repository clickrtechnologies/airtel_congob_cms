...
export class ApprovalComponent implements OnInit {
  ...
  console.log('==============================');
  console.log('Fetching User Song Content Page');
  console.log('User ID:', userId);
  console.log('Current Page:', this.currentSongPage);
  console.log('Page Size:', this.songPageSize);
  ...
  this.approvalService
    ...
    .subscribe({
      next: (response: any) => {
        ...
        console.log('Total Records Received:', list.length);
        ...
        console.log('Pagination Info → ',
          'Total Pages:', this.songTotalPages,
          'Total Items:', this.totalItems,
          'Current Page:', this.currentSongPage
        );

        this.globalSelectAll = true;

        // FILTER only unapproved + contract available
        ...
        console.log('Unapproved Songs Count:', unapprovedSongs.length);
        console.log('Unapproved Songs List:', unapprovedSongs);
        ...
        console.log('Unique CP List:', this.uniqueCpList);
        ...
        console.log('Mapped Approvals:', this.approvals);
        console.log('Approvals Count:', this.approvals.length);

        // Apply CP filter
        this.filterApprovals();

        console.log('Filtered Approvals:', this.filteredApprovals);
        console.log('==============================');
      },

      error: (error) => {
        console.error('Error fetching song content page:', error);
        this.approvals = [];
